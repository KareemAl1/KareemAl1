...
|---|---|---|---|---|
| CoachDash | AI-powered developer activity tracker with Node.js/Express backend, PostgreSQL database, and Anthropic API coaching summaries | Next.js, TypeScript, Node.js, Express, PostgreSQL | [Live](https://coachdash.vercel.app) | [Repo](https://github.com/KareemAl1/coachdash) |
